...
# code=L1
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/"$code" 30 /home/garner1/Work/dataset/bliss
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=L5
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/"$code"_"$barcode" 30 /home/garner1/Work/dataset/bliss
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=L7_NT
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/L7_"$barcode" 30 /home/garner1/Work/dataset/bliss
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=L10
# exp="$code"
# bash bliss.sh "$exp" mus ../patterns/"$code"_"$barcode" 30 /home/garner1/Work/dataset/bliss
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=RM118
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/"$code"_*_"$barcode" 30 /home/garner1/Work/dataset
...
# code=RM118
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/"$code"_*_"$barcode" 30 /media/bicroserver_2-seq/BICRO63/FASTQ
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=BB76
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/"$code"_*_"$barcode" 10 /media/bicroserver_2-seq/BICRO61/BICRO61-62826764/FASTQ
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=BB81
# exp="$code"
# bash bliss.sh "$exp" human ../patterns/"$code"_*_"$barcode" 30 /media/bicroserver_2-seq/BICRO61/BICRO61-62826764/FASTQ
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=BB67
# exp="$code"
# bash bliss.sh "$exp" Mus ../patterns/*"$code"_*_"$barcode" 5 /media/bicroserver_2-seq/BICRO59/BICRO59/FASTQ
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=BB67
# exp="$code"
# ./bliss_2.sh "$exp" Mus ../patterns/*"$code"_*_"$barcode" 5 /media/bicroserver_2-seq/BICRO59/BICRO59/FASTQ
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# code=BB68
# exp="$code"
# ./bliss_1.sh "$exp" Mus ../patterns/*"$code"_*_"$barcode" 5 /media/bicroserver_2-seq/BICRO59/BICRO59/FASTQ
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# run=IMB03
# exp="$run"_"$code"
# ./bliss_1.sh "$exp" human ../patterns/*"$code"_*_"$barcode" 30 /media/bicroserver_2-seq/COLLABORATIONS/IMB03/fastq
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# run=IMB03
# exp="$run"_"$code"
# ./bliss_2.sh "$exp" human ../patterns/*"$code"_*_"$barcode" 30 /media/bicroserver_2-seq/COLLABORATIONS/IMB03/fastq
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# run=IMB04
# exp="$run"_"$code"
# ./bliss_1.sh "$exp" human ../patterns/*"$code"_*_"$barcode" 30 /media/bicroserver_2-seq/COLLABORATIONS/IMB04/fastq
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# run=IMB04
# exp="$run"_"$code"
# ./bliss_2.sh "$exp" human ../patterns/*"$code"_*_"$barcode" 30 /media/bicroserver_2-seq/COLLABORATIONS/IMB04/fastq
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# run=IMB02
# exp="$run"_"$code"
# ./bliss_1.sh "$exp" human ../patterns/*"$exp"_*_"$barcode" 30 /media/bicroserver_2-seq/COLLABORATIONS/IMB02/fastq
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
...
# run=IMB02
# exp="$run"_"$code"
# ./bliss_2.sh "$exp" human ../patterns/*"$exp"_*_"$barcode" 30 /media/bicroserver_2-seq/COLLABORATIONS/IMB02/fastq
# mkdir -p ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
# mv ~/Work/dataset/bliss/"$exp"/outdata/* ~/Work/dataset/bliss/"$exp"/outdata_"$barcode"
